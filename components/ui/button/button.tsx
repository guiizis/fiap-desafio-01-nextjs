...
const baseClasses =
  'inline-flex items-center justify-center rounded-md border px-4 py-2 text-body-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed';
...
const variantToneClasses: Record<ButtonVariant, Record<ButtonTone, string>> = {
  solid: {
    ...
    secondary: 'border-secondary bg-secondary text-surface hover:bg-secondary-hover',
